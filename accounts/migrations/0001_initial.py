    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Student'), ('hod', 'HOD'), ('tpo', 'TPO'), ('company', 'Company')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_10th_percentage', models.FloatField(blank=True, null=True)),
                ('min_12th_percentage', models.FloatField(blank=True, null=True)),
                ('min_diploma_percentage', models.FloatField(blank=True, null=True)),
                ('min_bachelor_percentage', models.FloatField(blank=True, null=True)),
                ('min_master_percentage', models.FloatField(blank=True, null=True)),
                ('max_current_backlogs', models.IntegerField(blank=True, null=True)),
                ('max_history_backlogs', models.IntegerField(blank=True, null=True)),
